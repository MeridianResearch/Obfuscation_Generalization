#!/usr/bin/env bash
# Pod 2 — war/42 eval_war second half (5 big steps). ~27 min.
...
JOBS=(
  "sum|leave_out_war_refined2|42|refined2/eval_war_with_summary|3000,3200,3400,3600,3800"
)
...
for entry in "${JOBS[@]}"; do
  ...
  LOG_FILE_EXPR="${LOG_DIR}/pod2_${TYPE}_${DATA}_ts${SEED}_${EXP_TAG}_\$(date +%Y%m%d_%H%M%S).log"
