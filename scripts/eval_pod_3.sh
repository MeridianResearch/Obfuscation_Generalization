#!/usr/bin/env bash
# Pod 3 — war/42 medical first half (10 small steps). ~12 min.
...
JOBS=(
  "sum|leave_out_war_refined2|42|refined2/eval_sycophancy_medical_with_summary|25,200,400,600,800,1000,1200,1400,1600,1800"
)
...
for entry in "${JOBS[@]}"; do
  ...
  LOG_FILE_EXPR="${LOG_DIR}/pod3_${TYPE}_${DATA}_ts${SEED}_${EXP_TAG}_\$(date +%Y%m%d_%H%M%S).log"
