#!/usr/bin/env bash
# Pod 1 — war/42 eval_war first half (5 big steps). ~27 min.
...
JOBS=(
  "sum|leave_out_war_refined2|42|refined2/eval_war_with_summary|800,2200,2400,2600,2800"
)
...
for entry in "${JOBS[@]}"; do
  ...
  LOG_FILE_EXPR="${LOG_DIR}/pod1_${TYPE}_${DATA}_ts${SEED}_${EXP_TAG}_\$(date +%Y%m%d_%H%M%S).log"
