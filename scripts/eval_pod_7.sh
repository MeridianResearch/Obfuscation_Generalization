#!/usr/bin/env bash
# Pod 7 — syc/42 eval_syc tail + score/50 medical (2 big + 12 small). ~26 min.
...
JOBS=(
  "sum|leave_out_sycophancy_refined2|42|refined2/eval_sycophancy_with_summary|3600,3800"
  "sum|leave_out_score_refined2|50|refined2/eval_sycophancy_medical_with_summary|1600,1800,2000,2200,2400,2600,2800,3000,3200,3400,3600,3800"
)
...
for entry in "${JOBS[@]}"; do
  ...
  LOG_FILE_EXPR="${LOG_DIR}/pod7_${TYPE}_${DATA}_ts${SEED}_${EXP_TAG}_\$(date +%Y%m%d_%H%M%S).log"
