#!/usr/bin/env bash
# Pod 8 — score/33 score + score/24 med + code/42 med + code/24 med + score/42 med (1 big + 17 small). ~32 min.
...
JOBS=(
  "sum|leave_out_score_refined2|33|refined2/eval_score_with_summary|1400"
  "sum|leave_out_score_refined2|24|refined2/eval_sycophancy_medical_with_summary|2400,2600,2800,3000,3200,3400,3600,3800"
  "sum|leave_out_code_refined2|42|refined2/eval_sycophancy_medical_with_summary|2200,2400,2600,2800,3000,3200,3600"
  "sum|leave_out_code_refined2|24|refined2/eval_sycophancy_medical_with_summary|1200"
  "sum|leave_out_score_refined2|42|refined2/eval_sycophancy_medical_with_summary|1400"
)
...
for entry in "${JOBS[@]}"; do
  ...
  LOG_FILE_EXPR="${LOG_DIR}/pod8_${TYPE}_${DATA}_ts${SEED}_${EXP_TAG}_\$(date +%Y%m%d_%H%M%S).log"
