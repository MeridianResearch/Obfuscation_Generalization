#!/usr/bin/env bash
# Pod 4 — war/42 medical second half (10 small steps). ~12 min.
...
JOBS=(
  "sum|leave_out_war_refined2|42|refined2/eval_sycophancy_medical_with_summary|2000,2200,2400,2600,2800,3000,3200,3400,3600,3800"
)
...
for entry in "${JOBS[@]}"; do
  ...
  LOG_FILE_EXPR="${LOG_DIR}/pod4_${TYPE}_${DATA}_ts${SEED}_${EXP_TAG}_\$(date +%Y%m%d_%H%M%S).log"
